...
const quoteButton = document.getElementById("search_quote_btn");
...
function displayQuotes(radioResult) {
  if (radioResult === "wisdom-value") {
    quote_display.innerHTML += wisdom.print() + "<br>" + "<hr>";
  } else {
    quote_display.innerHTML += inspirational.print() + "<br>" + "<hr>";
  }
}
